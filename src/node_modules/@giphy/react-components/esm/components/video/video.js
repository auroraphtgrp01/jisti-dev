...
var Video = function (_a) {
    ...
    var height = height_ || getGifHeight(gif, width);
    // state
    var _k = useState(getBestVideo(gif.video, width, height)), media = _k[0], setMedia = _k[1];
    var seek = useRef(0);
    if (!media) {
    ...
    var mountTime = useRef(Date.now());
    var hasPlayingFired = useRef(false);
    var loopNumber = useRef(0);
    var waitingCount = useRef(0);
    var quartilesFired = useRef(new Set());
    ...
    useEffect(function () {
        ...
        var newMedia = getBestVideo(gif.video, width, height);
    ...
    var _onError = useCallback(function () {
        var _a;
        ...
        if (code && (el === null || el === void 0 ? void 0 : el.src)) {
            var message = getErrorMessage(code, el === null || el === void 0 ? void 0 : el.src);
            console.error(message);
            onError === null || onError === void 0 ? void 0 : onError(code);
        }
    }, [onError]);
    var _onPlaying = useCallback(function () {
    ...
    var _onPaused = useCallback(function () { return onStateChange === null || onStateChange === void 0 ? void 0 : onStateChange('paused'); }, [onStateChange]);
    var _onTimeUpdate = useCallback(function () {
        var el = videoEl.current;
        if (el) {
            var playhead_1 = el.currentTime;
            quartileEvents.some(function (q) {
                if (shouldFireQuartile(q, playhead_1, el.duration, quartilesFired.current, loopNumber.current)) {
    ...
    var _onCanPlay = useCallback(function () { return onCanPlay === null || onCanPlay === void 0 ? void 0 : onCanPlay(); }, [onCanPlay]);
    var _onWaiting = useCallback(function () {
        var el = videoEl.current;
    ...
    var _onEnded = useCallback(function () {
    ...
    var _onEndFullscreen = useCallback(function () { return onEndFullscreen === null || onEndFullscreen === void 0 ? void 0 : onEndFullscreen(); }, [onEndFullscreen]);
    var tryAutoPlayWithSound = useCallback(function (videoEl) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (media === null || media === void 0 ? void 0 : media.url) ? (React.createElement("video", { crossOrigin: "anonymous", draggable: true, className: className, width: width, height: height, muted: muted, autoPlay: true, playsInline: true, ref: videoEl, src: media === null || media === void 0 ? void 0 : media.url, "data-giphy-id": gif.id }, ccEnabled && captionSrc && (React.createElement("track", { label: "English", kind: "subtitles", srcLang: ccLanguage, src: captionSrc, default: true })))) : null;
};
