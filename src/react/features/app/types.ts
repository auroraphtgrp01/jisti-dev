...
// Mobile imports removed for web-only build
...
export interface IReduxState {
    ...
    // 'features/call-integration': ICallIntegrationState; // Mobile feature removed
    ...
    // 'features/full-screen': IFullScreenState; // Mobile feature removed
    ...
    // Mobile features removed for web-only build
